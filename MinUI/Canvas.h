...
// themselves. 
// The set of all canvas is structured as a Tree, starting from the canvas 'root' 
...
class Canvas
{
	...
	std::vector <Canvas> m_childs;

	Vector2f m_widget_padding;
	Vector2f m_canvas_padding;
	...
	Canvas(std::string id, Vector2f position, Vector2f dimension,
	...
	void addCanvas(std::string id, Vector2f position, Vector2f dimension,
